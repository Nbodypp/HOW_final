...
int main(int argc, char *argv[])
{
  ...
  const double R_0 = 50./au_to_l_conv; //Initial distance from stars' center of mass to blackhole //orig 100.
  const double x_0 = 8.5/au_to_l_conv; //Initial x-coordinate for stars' center of mass //orig 20.
  ...
  double dt = 0.00005; //orig 0.0002
  double t = 0;
  double tmax = .4; //orig .5
